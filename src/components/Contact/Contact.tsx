        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__data">
              ...
              <span className="contact__data-infp">azamatreactjs@gmail.com</span>

              <a className="contact__button" href="mailto:azamatreactjs@gmail.com">
            ...
            <div className="contact__data">
              ...
              <a className="contact__button" href="https://t.me/azamatreactjs" target="_blank">
                Write me <ArrowRightLine />
              </a>
            </div>
            ...
            <div className="contact__data">
              ...
              <a className="contact__button" href="https://instagram.com/azamat_reactjs" target="_blank">
                Write me <ArrowRightLine />
              </a>
            </div>
          </div>
        ...
        <div className="contact__content">
          ...
          <form className="contact__form" id="contact-form">
            <div className="contact-form-div">
              <label className="contact__form-tag" htmlFor="full-name">Full Name</label>
              <input className="contact__form-input" id="full-name" placeholder="Write your full name" type="text" name="full-name" />
            </div>
            <div className="contact-form-div">
              <label className="contact__form-tag" htmlFor="email">Email</label>
              <input className="contact__form-input" id="email" placeholder="Write your email" type="email" name="email" />
            </div>
            <div className="contact-form-div contact__form-area">
              <label className="contact__form-tag" htmlFor="project">Project</label>
              <textarea className="contact__form-input" id="project" placeholder="Write your project" name="project"></textarea>
            </div>
